...
- **db_port (_number_)** -- port of the RethinkDB instance.
- **db_name (_string_)** -- database name of the RethinkDB instance.
...
- **users (_string[]_)**(optional) -- user array who will be chat users. Is used *only for @SUC* chat, as @SUC chat is having only two users.
...
- **userId (_ChatTypes_)** -- id of the user which leaving the chat.
